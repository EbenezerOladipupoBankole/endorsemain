...
const tiers = [
  {
    ...
    price: 'Free',
    frequency: '',
    features: ['3 documents/month', 'Basic signatures', 'Mobile access'],
    color: 'text-slate-600',
    buttonColor: 'bg-slate-800 hover:bg-slate-900 focus-visible:outline-slate-800',
  ...
  },
  {
    ...
    price: '$8',
    frequency: '/month',
    features: ['Unlimited documents', 'Invite signers', 'Audit trails', 'Custom fields'],
  ...
  },
  {
    ...
    price: '$15',
    frequency: '/month',
    features: ['Everything in Pro', 'Team management', 'Custom branding', 'Priority support'],
